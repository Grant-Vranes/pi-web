...
function getBaseDockIconPath() {
  // The padded icon generated by desktop/generate-mac-icon.mjs, matching the
  // icon electron-builder packages as the mac Dock icon; restoring it on
  // idle returns the Dock to its default appearance.
  return path.join(app.getAppPath(), "public", "icons", "icon-mac-512.png");
}
